 ...
 * generated in the com.greenland.UnitsConverterWS.wsimport.generated.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _In2CmResponse_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "in2cmResponse");
    private final static QName _F2CResponse_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "f2cResponse");
    private final static QName _C2F_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "c2f");
    private final static QName _C2FResponse_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "c2fResponse");
    private final static QName _F2C_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "f2c");
    private final static QName _Cm2In_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "cm2in");
    private final static QName _In2Cm_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "in2cm");
    private final static QName _Cm2InResponse_QNAME = new QName("http://ws.UnitsConverterWS.greenland.com/", "cm2inResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.greenland.UnitsConverterWS.wsimport.generated.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "in2cmResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "f2c")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "cm2in")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "in2cm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.UnitsConverterWS.greenland.com/", name = "cm2inResponse")
